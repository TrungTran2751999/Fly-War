...
public class BulletEnemy1{
    ...
    public static ArrayList<BulletEnemy1> bullets1;
    public static ArrayList<BulletEnemy1> bullets2;
    public static ArrayList<BulletEnemy1> bullets3;
    public static ArrayList<BulletEnemy1> bullets4;
    ...
    public BulletEnemy1(double x, double y, double w, double h, double speedY){
        this.x = x;
        this.y = y;
        this.w = w;
        this.h = h;
    ...
    public BulletEnemy1() throws IOException {
    ...
    public void bullet1Move(int i){
        if(PauseGame.isPause==false){
            ...
            collsionBound1.get(i).setLocation((int) bullets1.get(i).x, (int) bullets1.get(i).y);
    ...
    public void importImage() throws IOException {
        String path = "../source/bullet.png";
        imageBullet = ImageIO.read(new File(path));
    }
    public void fireBullet(double x, double y){
        bullets1.add(new BulletEnemy1(x+117, y+99, this.w, this.h, this.speedY));
        collsionBound1.add(new Rectangle((int) x+117, (int) y+99, (int) this.w, (int) this.h));

        bullets2.add(new BulletEnemy1(x+61, y+99, this.w, this.h, this.speedY));
        collsionBound2.add(new Rectangle((int) x+61, (int) y+99, (int) this.w, (int) this.h));

        bullets3.add(new BulletEnemy1(x+26, y+94, this.w, this.h, this.speedY));
        collsionBound3.add(new Rectangle((int) x+26, (int) y+94, (int) this.w, (int) this.h));

        bullets4.add(new BulletEnemy1(x+151, y+93, this.w, this.h, this.speedY));
        collsionBound4.add(new Rectangle((int) x+61, (int) y+99, (int) this.w, (int) this.h));
    }
    public double getX() {
        return x;
    }
